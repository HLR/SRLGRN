...
# class BertForQuestionAnsweringConfidence(AlbertModel):
class BertForQuestionAnsweringConfidence(AlbertPreTrainedModel):
    def __init__(self, config, num_labels=4, no_masking=False, lambda_scale=1.0):
