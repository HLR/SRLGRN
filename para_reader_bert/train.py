...
def main():
    ...
    if reader_cfg.do_train:
        ...
        state_dict, vocab_file = get_bert_model_from_pytorch_transformers_1(reader_cfg.bert_model)
        model.bert.load_state_dict(state_dict)
        tokenizer = BertTokenizer.from_pretrained(vocab_file, do_lower_case=reader_cfg.do_lower_case)
