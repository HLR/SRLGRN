...
def main():
    ...
    state_dict, vocab_file = get_bert_model_from_pytorch_transformers(sp_cfg.bert_model)
    model.bert.load_state_dict(state_dict)
    # tokenizer = AlbertTokenizer.from_pretrained(vocab_file, do_lower_case=sp_cfg.do_lower_case)
    tokenizer = AlbertTokenizer.from_pretrained(sp_cfg.bert_model, do_lower_case=sp_cfg.do_lower_case)
